...
public final class MpsqNpcPlacementScreen extends Screen {
    ...
    @Override protected void init(){asset=addDrawableChild(new TextFieldWidget(textRenderer,width/2-120,70,145,20,Text.literal("NPC-Modell-ID")));asset.setMaxLength(64);asset.setPlaceholder(Text.literal("Modell-ID"));
